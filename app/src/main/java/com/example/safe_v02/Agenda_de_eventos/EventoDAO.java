...
public class EventoDAO {
   ...
   public ArrayList obterTodos() {
      ...
      Cursor cursor = this.banco.query("eventos", new String[]{"id", "nome", "data", "tipo", "materia", "hora","descricao"}, (String)null, (String[])null, (String)null, (String)null, (String)null);
